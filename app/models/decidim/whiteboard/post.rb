...
module Decidim
  module Whiteboard
    # The data store for a Blog in the Decidim::Whiteboard component. It stores a
    # title, description and any other useful information to render a blog.
    class Post < Whiteboard::ApplicationRecord
      ...
      component_manifest_name "whiteboard"
      ...
      class << self
        ...
        def log_presenter_class_for(_log)
          Decidim::Whiteboard::AdminLog::PostPresenter
        end
      end
